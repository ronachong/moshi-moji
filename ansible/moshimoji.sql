...
ALTER TABLE auth_group OWNER TO mmuser;
...
ALTER TABLE auth_group_id_seq OWNER TO mmuser;
...
ALTER TABLE auth_group_permissions OWNER TO mmuser;
...
ALTER TABLE auth_group_permissions_id_seq OWNER TO mmuser;
...
ALTER TABLE auth_permission OWNER TO mmuser;
...
ALTER TABLE auth_permission_id_seq OWNER TO mmuser;
...
ALTER TABLE django_admin_log OWNER TO mmuser;
...
ALTER TABLE django_admin_log_id_seq OWNER TO mmuser;
...
ALTER TABLE django_content_type OWNER TO mmuser;
...
ALTER TABLE django_content_type_id_seq OWNER TO mmuser;
...
ALTER TABLE django_migrations OWNER TO mmuser;
...
ALTER TABLE django_migrations_id_seq OWNER TO mmuser;
...
ALTER TABLE django_session OWNER TO mmuser;

--
-- Name: gql_platform_author; Type: TABLE; Schema: public; Owner: mmuser
--

CREATE TABLE gql_platform_author (
    id integer NOT NULL,
...
ALTER TABLE gql_platform_author OWNER TO mmuser;

--
-- Name: gql_platform_author_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE gql_platform_author_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gql_platform_author_id_seq OWNER TO mmuser;

--
-- Name: gql_platform_author_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE gql_platform_author_id_seq OWNED BY gql_platform_author.id;
...
CREATE TABLE gql_platform_genre (
    id integer NOT NULL,
    name character varying(100) NOT NULL
);


ALTER TABLE gql_platform_genre OWNER TO mmuser;

--
-- Name: gql_platform_genre_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE gql_platform_genre_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gql_platform_genre_id_seq OWNER TO mmuser;

--
-- Name: gql_platform_genre_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE gql_platform_genre_id_seq OWNED BY gql_platform_genre.id;


--
-- Name: gql_platform_mangaseries; Type: TABLE; Schema: public; Owner: mmuser
--

CREATE TABLE gql_platform_mangaseries (
    id integer NOT NULL,
...
ALTER TABLE gql_platform_mangaseries OWNER TO mmuser;

--
-- Name: gql_platform_mangaseries_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE gql_platform_mangaseries_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gql_platform_mangaseries_id_seq OWNER TO mmuser;

--
-- Name: gql_platform_mangaseries_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE gql_platform_mangaseries_id_seq OWNED BY gql_platform_mangaseries.id;
...
CREATE TABLE gql_platform_userstatus (
    id integer NOT NULL,
    text text NOT NULL,
...
ALTER TABLE gql_platform_userstatus OWNER TO mmuser;

--
-- Name: gql_platform_userstatus_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE gql_platform_userstatus_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gql_platform_userstatus_id_seq OWNER TO mmuser;

--
-- Name: gql_platform_userstatus_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE gql_platform_userstatus_id_seq OWNED BY gql_platform_userstatus.id;
...
ALTER TABLE misago_acl_role OWNER TO mmuser;

--
-- Name: misago_acl_role_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_acl_role_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_acl_role_id_seq OWNER TO mmuser;

--
-- Name: misago_acl_role_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_acl_role_id_seq OWNED BY misago_acl_role.id;
...
CREATE TABLE misago_categories_category (
    id integer NOT NULL,
    special_role character varying(255),
    name character varying(255) NOT NULL,
...
ALTER TABLE misago_categories_category OWNER TO mmuser;

--
-- Name: misago_categories_category_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_categories_category_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_categories_category_id_seq OWNER TO mmuser;

--
-- Name: misago_categories_category_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_categories_category_id_seq OWNED BY misago_categories_category.id;
...
CREATE TABLE misago_categories_categoryrole (
    id integer NOT NULL,
    name character varying(255) NOT NULL,
    special_role character varying(255),
    permissions jsonb NOT NULL
...
ALTER TABLE misago_categories_categoryrole OWNER TO mmuser;

--
-- Name: misago_categories_categoryrole_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_categories_categoryrole_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_categories_categoryrole_id_seq OWNER TO mmuser;

--
-- Name: misago_categories_categoryrole_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_categories_categoryrole_id_seq OWNED BY misago_categories_categoryrole.id;
...
CREATE TABLE misago_categories_rolecategoryacl (
    id integer NOT NULL,
...
ALTER TABLE misago_categories_rolecategoryacl OWNER TO mmuser;

--
-- Name: misago_categories_rolecategoryacl_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_categories_rolecategoryacl_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_categories_rolecategoryacl_id_seq OWNER TO mmuser;

--
-- Name: misago_categories_rolecategoryacl_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_categories_rolecategoryacl_id_seq OWNED BY misago_categories_rolecategoryacl.id;
...
CREATE TABLE misago_conf_setting (
    id integer NOT NULL,
...
ALTER TABLE misago_conf_setting OWNER TO mmuser;

--
-- Name: misago_conf_setting_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_conf_setting_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_conf_setting_id_seq OWNER TO mmuser;

--
-- Name: misago_conf_setting_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_conf_setting_id_seq OWNED BY misago_conf_setting.id;
...
CREATE TABLE misago_conf_settingsgroup (
    id integer NOT NULL,
...
ALTER TABLE misago_conf_settingsgroup OWNER TO mmuser;

--
-- Name: misago_conf_settingsgroup_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_conf_settingsgroup_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_conf_settingsgroup_id_seq OWNER TO mmuser;

--
-- Name: misago_conf_settingsgroup_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_conf_settingsgroup_id_seq OWNED BY misago_conf_settingsgroup.id;
...
CREATE TABLE misago_core_cacheversion (
    id integer NOT NULL,
...
ALTER TABLE misago_core_cacheversion OWNER TO mmuser;

--
-- Name: misago_core_cacheversion_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_core_cacheversion_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_core_cacheversion_id_seq OWNER TO mmuser;

--
-- Name: misago_core_cacheversion_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_core_cacheversion_id_seq OWNED BY misago_core_cacheversion.id;
...
CREATE TABLE misago_readtracker_postread (
    id integer NOT NULL,
...
ALTER TABLE misago_readtracker_postread OWNER TO mmuser;

--
-- Name: misago_readtracker_postread_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_readtracker_postread_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_readtracker_postread_id_seq OWNER TO mmuser;

--
-- Name: misago_readtracker_postread_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_readtracker_postread_id_seq OWNED BY misago_readtracker_postread.id;
...
CREATE TABLE misago_threads_attachment (
    id integer NOT NULL,
...
ALTER TABLE misago_threads_attachment OWNER TO mmuser;

--
-- Name: misago_threads_attachment_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_threads_attachment_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_threads_attachment_id_seq OWNER TO mmuser;

--
-- Name: misago_threads_attachment_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_threads_attachment_id_seq OWNED BY misago_threads_attachment.id;
...
CREATE TABLE misago_threads_attachmenttype (
    id integer NOT NULL,
    name character varying(255) NOT NULL,
...
ALTER TABLE misago_threads_attachmenttype OWNER TO mmuser;

--
-- Name: misago_threads_attachmenttype_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_threads_attachmenttype_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_threads_attachmenttype_id_seq OWNER TO mmuser;

--
-- Name: misago_threads_attachmenttype_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_threads_attachmenttype_id_seq OWNED BY misago_threads_attachmenttype.id;
...
CREATE TABLE misago_threads_attachmenttype_limit_downloads_to (
    id integer NOT NULL,
...
ALTER TABLE misago_threads_attachmenttype_limit_downloads_to OWNER TO mmuser;

--
-- Name: misago_threads_attachmenttype_limit_downloads_to_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_threads_attachmenttype_limit_downloads_to_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_threads_attachmenttype_limit_downloads_to_id_seq OWNER TO mmuser;

--
-- Name: misago_threads_attachmenttype_limit_downloads_to_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_threads_attachmenttype_limit_downloads_to_id_seq OWNED BY misago_threads_attachmenttype_limit_downloads_to.id;
...
CREATE TABLE misago_threads_attachmenttype_limit_uploads_to (
    id integer NOT NULL,
    attachmenttype_id integer NOT NULL,
    role_id integer NOT NULL
);
...
ALTER TABLE misago_threads_attachmenttype_limit_uploads_to OWNER TO mmuser;

--
-- Name: misago_threads_attachmenttype_limit_uploads_to_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_threads_attachmenttype_limit_uploads_to_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_threads_attachmenttype_limit_uploads_to_id_seq OWNER TO mmuser;

--
-- Name: misago_threads_attachmenttype_limit_uploads_to_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_threads_attachmenttype_limit_uploads_to_id_seq OWNED BY misago_threads_attachmenttype_limit_uploads_to.id;
...
CREATE TABLE misago_threads_poll (
    id integer NOT NULL,
...
ALTER TABLE misago_threads_poll OWNER TO mmuser;

--
-- Name: misago_threads_poll_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_threads_poll_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_threads_poll_id_seq OWNER TO mmuser;

--
-- Name: misago_threads_poll_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_threads_poll_id_seq OWNED BY misago_threads_poll.id;
...
CREATE TABLE misago_threads_pollvote (
    id integer NOT NULL,
...
ALTER TABLE misago_threads_pollvote OWNER TO mmuser;

--
-- Name: misago_threads_pollvote_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_threads_pollvote_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_threads_pollvote_id_seq OWNER TO mmuser;

--
-- Name: misago_threads_pollvote_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_threads_pollvote_id_seq OWNED BY misago_threads_pollvote.id;
...
CREATE TABLE misago_threads_post (
    id integer NOT NULL,
    poster_name character varying(255) NOT NULL,
    poster_ip inet NOT NULL,
...
ALTER TABLE misago_threads_post OWNER TO mmuser;

--
-- Name: misago_threads_post_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_threads_post_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_threads_post_id_seq OWNER TO mmuser;

--
-- Name: misago_threads_post_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_threads_post_id_seq OWNED BY misago_threads_post.id;
...
CREATE TABLE misago_threads_post_mentions (
    id integer NOT NULL,
    post_id integer NOT NULL,
    user_id integer NOT NULL
);
...
ALTER TABLE misago_threads_post_mentions OWNER TO mmuser;

--
-- Name: misago_threads_post_mentions_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_threads_post_mentions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_threads_post_mentions_id_seq OWNER TO mmuser;

--
-- Name: misago_threads_post_mentions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_threads_post_mentions_id_seq OWNED BY misago_threads_post_mentions.id;
...
CREATE TABLE misago_threads_postedit (
    id integer NOT NULL,
...
ALTER TABLE misago_threads_postedit OWNER TO mmuser;

--
-- Name: misago_threads_postedit_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_threads_postedit_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_threads_postedit_id_seq OWNER TO mmuser;

--
-- Name: misago_threads_postedit_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_threads_postedit_id_seq OWNED BY misago_threads_postedit.id;
...
CREATE TABLE misago_threads_postlike (
    id integer NOT NULL,
...
ALTER TABLE misago_threads_postlike OWNER TO mmuser;

--
-- Name: misago_threads_postlike_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_threads_postlike_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_threads_postlike_id_seq OWNER TO mmuser;

--
-- Name: misago_threads_postlike_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_threads_postlike_id_seq OWNED BY misago_threads_postlike.id;
...
CREATE TABLE misago_threads_subscription (
    id integer NOT NULL,
    last_read_on timestamp with time zone NOT NULL,
...
ALTER TABLE misago_threads_subscription OWNER TO mmuser;

--
-- Name: misago_threads_subscription_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_threads_subscription_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_threads_subscription_id_seq OWNER TO mmuser;

--
-- Name: misago_threads_subscription_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_threads_subscription_id_seq OWNED BY misago_threads_subscription.id;
...
CREATE TABLE misago_threads_thread (
    id integer NOT NULL,
...
ALTER TABLE misago_threads_thread OWNER TO mmuser;

--
-- Name: misago_threads_thread_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_threads_thread_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_threads_thread_id_seq OWNER TO mmuser;

--
-- Name: misago_threads_thread_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_threads_thread_id_seq OWNED BY misago_threads_thread.id;
...
CREATE TABLE misago_threads_threadparticipant (
    id integer NOT NULL,
    thread_id integer NOT NULL,
    user_id integer NOT NULL,
...
ALTER TABLE misago_threads_threadparticipant OWNER TO mmuser;

--
-- Name: misago_threads_threadparticipant_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_threads_threadparticipant_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_threads_threadparticipant_id_seq OWNER TO mmuser;

--
-- Name: misago_threads_threadparticipant_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_threads_threadparticipant_id_seq OWNED BY misago_threads_threadparticipant.id;
...
CREATE TABLE misago_users_activityranking (
    id integer NOT NULL,
    user_id integer NOT NULL,
...
ALTER TABLE misago_users_activityranking OWNER TO mmuser;

--
-- Name: misago_users_activityranking_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_users_activityranking_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_users_activityranking_id_seq OWNER TO mmuser;

--
-- Name: misago_users_activityranking_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_users_activityranking_id_seq OWNED BY misago_users_activityranking.id;
...
CREATE TABLE misago_users_avatar (
    id integer NOT NULL,
    user_id integer NOT NULL,
    size integer NOT NULL,
...
ALTER TABLE misago_users_avatar OWNER TO mmuser;

--
-- Name: misago_users_avatar_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_users_avatar_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_users_avatar_id_seq OWNER TO mmuser;

--
-- Name: misago_users_avatar_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_users_avatar_id_seq OWNED BY misago_users_avatar.id;
...
CREATE TABLE misago_users_avatargallery (
    id integer NOT NULL,
...
ALTER TABLE misago_users_avatargallery OWNER TO mmuser;

--
-- Name: misago_users_avatargallery_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_users_avatargallery_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_users_avatargallery_id_seq OWNER TO mmuser;

--
-- Name: misago_users_avatargallery_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_users_avatargallery_id_seq OWNED BY misago_users_avatargallery.id;
...
ALTER TABLE misago_users_ban OWNER TO mmuser;

--
-- Name: misago_users_ban_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_users_ban_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_users_ban_id_seq OWNER TO mmuser;

--
-- Name: misago_users_ban_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_users_ban_id_seq OWNED BY misago_users_ban.id;
...
CREATE TABLE misago_users_bancache (
    user_message text,
    staff_message text,
...
ALTER TABLE misago_users_bancache OWNER TO mmuser;

--
-- Name: misago_users_online; Type: TABLE; Schema: public; Owner: mmuser
--

CREATE TABLE misago_users_online (
...
ALTER TABLE misago_users_online OWNER TO mmuser;

--
-- Name: misago_users_rank; Type: TABLE; Schema: public; Owner: mmuser
--

CREATE TABLE misago_users_rank (
    id integer NOT NULL,
    name character varying(255) NOT NULL,
    slug character varying(255) NOT NULL,
    description text,
...
ALTER TABLE misago_users_rank OWNER TO mmuser;

--
-- Name: misago_users_rank_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_users_rank_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_users_rank_id_seq OWNER TO mmuser;

--
-- Name: misago_users_rank_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_users_rank_id_seq OWNED BY misago_users_rank.id;
...
CREATE TABLE misago_users_rank_roles (
    id integer NOT NULL,
...
ALTER TABLE misago_users_rank_roles OWNER TO mmuser;

--
-- Name: misago_users_rank_roles_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_users_rank_roles_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_users_rank_roles_id_seq OWNER TO mmuser;

--
-- Name: misago_users_rank_roles_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_users_rank_roles_id_seq OWNED BY misago_users_rank_roles.id;
...
CREATE TABLE misago_users_user (
    id integer NOT NULL,
    ...
    rank_id integer,
    profile_fields hstore NOT NULL,
...
ALTER TABLE misago_users_user OWNER TO mmuser;

--
-- Name: misago_users_user_blocks; Type: TABLE; Schema: public; Owner: mmuser
--

CREATE TABLE misago_users_user_blocks (
    id integer NOT NULL,
...
ALTER TABLE misago_users_user_blocks OWNER TO mmuser;

--
-- Name: misago_users_user_blocks_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_users_user_blocks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_users_user_blocks_id_seq OWNER TO mmuser;

--
-- Name: misago_users_user_blocks_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_users_user_blocks_id_seq OWNED BY misago_users_user_blocks.id;
...
CREATE TABLE misago_users_user_follows (
    id integer NOT NULL,
    from_user_id integer NOT NULL,
    to_user_id integer NOT NULL
);
...
ALTER TABLE misago_users_user_follows OWNER TO mmuser;

--
-- Name: misago_users_user_follows_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_users_user_follows_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_users_user_follows_id_seq OWNER TO mmuser;

--
-- Name: misago_users_user_follows_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_users_user_follows_id_seq OWNED BY misago_users_user_follows.id;
...
CREATE TABLE misago_users_user_groups (
    id integer NOT NULL,
    user_id integer NOT NULL,
    group_id integer NOT NULL
);
...
ALTER TABLE misago_users_user_groups OWNER TO mmuser;

--
-- Name: misago_users_user_groups_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_users_user_groups_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_users_user_groups_id_seq OWNER TO mmuser;

--
-- Name: misago_users_user_groups_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_users_user_groups_id_seq OWNED BY misago_users_user_groups.id;
...
CREATE SEQUENCE misago_users_user_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_users_user_id_seq OWNER TO mmuser;

--
-- Name: misago_users_user_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_users_user_id_seq OWNED BY misago_users_user.id;
...
CREATE TABLE misago_users_user_roles (
    id integer NOT NULL,
    user_id integer NOT NULL,
    role_id integer NOT NULL
);
...
ALTER TABLE misago_users_user_roles OWNER TO mmuser;

--
-- Name: misago_users_user_roles_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_users_user_roles_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_users_user_roles_id_seq OWNER TO mmuser;

--
-- Name: misago_users_user_roles_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_users_user_roles_id_seq OWNED BY misago_users_user_roles.id;
...
CREATE TABLE misago_users_user_user_permissions (
    id integer NOT NULL,
    user_id integer NOT NULL,
    permission_id integer NOT NULL
);
...
ALTER TABLE misago_users_user_user_permissions OWNER TO mmuser;

--
-- Name: misago_users_user_user_permissions_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_users_user_user_permissions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_users_user_user_permissions_id_seq OWNER TO mmuser;

--
-- Name: misago_users_user_user_permissions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_users_user_user_permissions_id_seq OWNED BY misago_users_user_user_permissions.id;
...
CREATE TABLE misago_users_usernamechange (
    id integer NOT NULL,
...
ALTER TABLE misago_users_usernamechange OWNER TO mmuser;

--
-- Name: misago_users_usernamechange_id_seq; Type: SEQUENCE; Schema: public; Owner: mmuser
--

CREATE SEQUENCE misago_users_usernamechange_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE misago_users_usernamechange_id_seq OWNER TO mmuser;

--
-- Name: misago_users_usernamechange_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mmuser
--

ALTER SEQUENCE misago_users_usernamechange_id_seq OWNED BY misago_users_usernamechange.id;
...
ALTER TABLE ONLY gql_platform_author ALTER COLUMN id SET DEFAULT nextval('gql_platform_author_id_seq'::regclass);
...
ALTER TABLE ONLY gql_platform_genre ALTER COLUMN id SET DEFAULT nextval('gql_platform_genre_id_seq'::regclass);
...
ALTER TABLE ONLY gql_platform_mangaseries ALTER COLUMN id SET DEFAULT nextval('gql_platform_mangaseries_id_seq'::regclass);
...
ALTER TABLE ONLY gql_platform_userstatus ALTER COLUMN id SET DEFAULT nextval('gql_platform_userstatus_id_seq'::regclass);
...
ALTER TABLE ONLY misago_acl_role ALTER COLUMN id SET DEFAULT nextval('misago_acl_role_id_seq'::regclass);
...
ALTER TABLE ONLY misago_categories_category ALTER COLUMN id SET DEFAULT nextval('misago_categories_category_id_seq'::regclass);
...
ALTER TABLE ONLY misago_categories_categoryrole ALTER COLUMN id SET DEFAULT nextval('misago_categories_categoryrole_id_seq'::regclass);
...
ALTER TABLE ONLY misago_categories_rolecategoryacl ALTER COLUMN id SET DEFAULT nextval('misago_categories_rolecategoryacl_id_seq'::regclass);
...
ALTER TABLE ONLY misago_conf_setting ALTER COLUMN id SET DEFAULT nextval('misago_conf_setting_id_seq'::regclass);
...
ALTER TABLE ONLY misago_conf_settingsgroup ALTER COLUMN id SET DEFAULT nextval('misago_conf_settingsgroup_id_seq'::regclass);
...
ALTER TABLE ONLY misago_core_cacheversion ALTER COLUMN id SET DEFAULT nextval('misago_core_cacheversion_id_seq'::regclass);
...
ALTER TABLE ONLY misago_readtracker_postread ALTER COLUMN id SET DEFAULT nextval('misago_readtracker_postread_id_seq'::regclass);
...
ALTER TABLE ONLY misago_threads_attachment ALTER COLUMN id SET DEFAULT nextval('misago_threads_attachment_id_seq'::regclass);
...
ALTER TABLE ONLY misago_threads_attachmenttype ALTER COLUMN id SET DEFAULT nextval('misago_threads_attachmenttype_id_seq'::regclass);
...
ALTER TABLE ONLY misago_threads_attachmenttype_limit_downloads_to ALTER COLUMN id SET DEFAULT nextval('misago_threads_attachmenttype_limit_downloads_to_id_seq'::regclass);
...
ALTER TABLE ONLY misago_threads_attachmenttype_limit_uploads_to ALTER COLUMN id SET DEFAULT nextval('misago_threads_attachmenttype_limit_uploads_to_id_seq'::regclass);
...
ALTER TABLE ONLY misago_threads_poll ALTER COLUMN id SET DEFAULT nextval('misago_threads_poll_id_seq'::regclass);
...
ALTER TABLE ONLY misago_threads_pollvote ALTER COLUMN id SET DEFAULT nextval('misago_threads_pollvote_id_seq'::regclass);
...
ALTER TABLE ONLY misago_threads_post ALTER COLUMN id SET DEFAULT nextval('misago_threads_post_id_seq'::regclass);
...
ALTER TABLE ONLY misago_threads_post_mentions ALTER COLUMN id SET DEFAULT nextval('misago_threads_post_mentions_id_seq'::regclass);
...
ALTER TABLE ONLY misago_threads_postedit ALTER COLUMN id SET DEFAULT nextval('misago_threads_postedit_id_seq'::regclass);
...
ALTER TABLE ONLY misago_threads_postlike ALTER COLUMN id SET DEFAULT nextval('misago_threads_postlike_id_seq'::regclass);
...
ALTER TABLE ONLY misago_threads_subscription ALTER COLUMN id SET DEFAULT nextval('misago_threads_subscription_id_seq'::regclass);
...
ALTER TABLE ONLY misago_threads_thread ALTER COLUMN id SET DEFAULT nextval('misago_threads_thread_id_seq'::regclass);
...
ALTER TABLE ONLY misago_threads_threadparticipant ALTER COLUMN id SET DEFAULT nextval('misago_threads_threadparticipant_id_seq'::regclass);
...
ALTER TABLE ONLY misago_users_activityranking ALTER COLUMN id SET DEFAULT nextval('misago_users_activityranking_id_seq'::regclass);
...
ALTER TABLE ONLY misago_users_avatar ALTER COLUMN id SET DEFAULT nextval('misago_users_avatar_id_seq'::regclass);
...
ALTER TABLE ONLY misago_users_avatargallery ALTER COLUMN id SET DEFAULT nextval('misago_users_avatargallery_id_seq'::regclass);
...
ALTER TABLE ONLY misago_users_ban ALTER COLUMN id SET DEFAULT nextval('misago_users_ban_id_seq'::regclass);
...
ALTER TABLE ONLY misago_users_rank ALTER COLUMN id SET DEFAULT nextval('misago_users_rank_id_seq'::regclass);
...
ALTER TABLE ONLY misago_users_rank_roles ALTER COLUMN id SET DEFAULT nextval('misago_users_rank_roles_id_seq'::regclass);
...
ALTER TABLE ONLY misago_users_user ALTER COLUMN id SET DEFAULT nextval('misago_users_user_id_seq'::regclass);
...
ALTER TABLE ONLY misago_users_user_blocks ALTER COLUMN id SET DEFAULT nextval('misago_users_user_blocks_id_seq'::regclass);
...
ALTER TABLE ONLY misago_users_user_follows ALTER COLUMN id SET DEFAULT nextval('misago_users_user_follows_id_seq'::regclass);
...
ALTER TABLE ONLY misago_users_user_groups ALTER COLUMN id SET DEFAULT nextval('misago_users_user_groups_id_seq'::regclass);
...
ALTER TABLE ONLY misago_users_user_roles ALTER COLUMN id SET DEFAULT nextval('misago_users_user_roles_id_seq'::regclass);
...
ALTER TABLE ONLY misago_users_user_user_permissions ALTER COLUMN id SET DEFAULT nextval('misago_users_user_user_permissions_id_seq'::regclass);
...
ALTER TABLE ONLY misago_users_usernamechange ALTER COLUMN id SET DEFAULT nextval('misago_users_usernamechange_id_seq'::regclass);
...
--
-- Data for Name: gql_platform_author; Type: TABLE DATA; Schema: public; Owner: mmuser
--

COPY gql_platform_author (id, first_name, last_name) FROM stdin;
\.


--
-- Name: gql_platform_author_id_seq; Type: SEQUENCE SET; Schema: public; Owner: mmuser
--

SELECT pg_catalog.setval('gql_platform_author_id_seq', 1, false);
...
COPY gql_platform_genre (id, name) FROM stdin;
\.
...
SELECT pg_catalog.setval('gql_platform_genre_id_seq', 1, false);


--
-- Data for Name: gql_platform_mangaseries; Type: TABLE DATA; Schema: public; Owner: mmuser
--

COPY gql_platform_mangaseries (id, title, author_id, genre_id) FROM stdin;
\.


--
-- Name: gql_platform_mangaseries_id_seq; Type: SEQUENCE SET; Schema: public; Owner: mmuser
--

SELECT pg_catalog.setval('gql_platform_mangaseries_id_seq', 1, false);
...
COPY gql_platform_userstatus (id, text, creation_date, user_id) FROM stdin;
...
SELECT pg_catalog.setval('gql_platform_userstatus_id_seq', 2, true);
...
COPY misago_acl_role (id, name, special_role, permissions) FROM stdin;
...
SELECT pg_catalog.setval('misago_acl_role_id_seq', 9, true);
...
SELECT pg_catalog.setval('misago_categories_category_id_seq', 3, true);
...
COPY misago_categories_categoryrole (id, name, special_role, permissions) FROM stdin;
...
SELECT pg_catalog.setval('misago_categories_categoryrole_id_seq', 7, true);
...
COPY misago_categories_rolecategoryacl (id, category_id, category_role_id, role_id) FROM stdin;
1	3	6	3
2	3	4	1
3	3	2	2
\.
...
SELECT pg_catalog.setval('misago_categories_rolecategoryacl_id_seq', 3, true);
...
COPY misago_conf_setting (id, setting, name, description, legend, "order", dry_value, default_value, python_type, is_public, is_lazy, form_field, field_extra, group_id) FROM stdin;
...
SELECT pg_catalog.setval('misago_conf_setting_id_seq', 48, true);
...
COPY misago_conf_settingsgroup (id, key, name, description) FROM stdin;
...
SELECT pg_catalog.setval('misago_conf_settingsgroup_id_seq', 5, true);
...
COPY misago_core_cacheversion (id, cache, version) FROM stdin;
2	misago_bans	0
1	misago_acl	1
\.
...
SELECT pg_catalog.setval('misago_core_cacheversion_id_seq', 2, true);
...
COPY misago_readtracker_postread (id, last_read_on, category_id, post_id, thread_id, user_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_readtracker_postread_id_seq', 1, false);
...
COPY misago_threads_attachment (id, secret, uploaded_on, uploader_name, uploader_slug, uploader_ip, filename, size, thumbnail, image, file, post_id, filetype_id, uploader_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_threads_attachment_id_seq', 1, false);
...
COPY misago_threads_attachmenttype (id, name, extensions, mimetypes, size_limit, status) FROM stdin;
...
SELECT pg_catalog.setval('misago_threads_attachmenttype_id_seq', 12, true);
...
COPY misago_threads_attachmenttype_limit_downloads_to (id, attachmenttype_id, role_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_threads_attachmenttype_limit_downloads_to_id_seq', 1, false);
...
COPY misago_threads_attachmenttype_limit_uploads_to (id, attachmenttype_id, role_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_threads_attachmenttype_limit_uploads_to_id_seq', 1, false);
...
COPY misago_threads_poll (id, poster_name, poster_slug, poster_ip, posted_on, length, question, choices, allowed_choices, allow_revotes, votes, is_public, category_id, poster_id, thread_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_threads_poll_id_seq', 1, false);
...
COPY misago_threads_pollvote (id, voter_name, voter_slug, voter_ip, voted_on, choice_hash, category_id, poll_id, thread_id, voter_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_threads_pollvote_id_seq', 1, false);
...
SELECT pg_catalog.setval('misago_threads_post_id_seq', 1, false);
...
COPY misago_threads_post_mentions (id, post_id, user_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_threads_post_mentions_id_seq', 1, false);
...
COPY misago_threads_postedit (id, edited_on, editor_name, editor_slug, editor_ip, edited_from, edited_to, category_id, editor_id, post_id, thread_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_threads_postedit_id_seq', 1, false);
...
COPY misago_threads_postlike (id, liker_name, liker_slug, liker_ip, liked_on, category_id, post_id, thread_id, liker_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_threads_postlike_id_seq', 1, false);
...
COPY misago_threads_subscription (id, last_read_on, send_email, category_id, thread_id, user_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_threads_subscription_id_seq', 1, false);
...
SELECT pg_catalog.setval('misago_threads_thread_id_seq', 1, false);
...
COPY misago_threads_threadparticipant (id, thread_id, user_id, is_owner) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_threads_threadparticipant_id_seq', 1, false);
...
COPY misago_users_activityranking (id, user_id, score) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_users_activityranking_id_seq', 1, false);
...
COPY misago_users_avatar (id, user_id, size, image) FROM stdin;
...
SELECT pg_catalog.setval('misago_users_avatar_id_seq', 7, true);
...
COPY misago_users_avatargallery (id, gallery, image) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_users_avatargallery_id_seq', 1, false);
...
COPY misago_users_ban (id, check_type, banned_value, user_message, staff_message, expires_on, is_checked, registration_only) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_users_ban_id_seq', 1, false);
...
COPY misago_users_bancache (user_message, staff_message, bans_version, expires_on, ban_id, user_id) FROM stdin;
\.
...
COPY misago_users_online (current_ip, last_click, user_id) FROM stdin;
...
COPY misago_users_rank (id, name, slug, description, title, css_class, is_default, is_tab, "order") FROM stdin;
...
SELECT pg_catalog.setval('misago_users_rank_id_seq', 2, true);
...
COPY misago_users_rank_roles (id, rank_id, role_id) FROM stdin;
1	1	3
2	1	8
3	1	9
4	1	6
...
SELECT pg_catalog.setval('misago_users_rank_roles_id_seq', 5, true);
...
COPY misago_users_user_blocks (id, from_user_id, to_user_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_users_user_blocks_id_seq', 1, false);
...
COPY misago_users_user_follows (id, from_user_id, to_user_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_users_user_follows_id_seq', 1, false);
...
COPY misago_users_user_groups (id, user_id, group_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_users_user_groups_id_seq', 1, false);
...
SELECT pg_catalog.setval('misago_users_user_id_seq', 1, true);
...
COPY misago_users_user_roles (id, user_id, role_id) FROM stdin;
1	1	1
\.
...
SELECT pg_catalog.setval('misago_users_user_roles_id_seq', 1, true);
...
COPY misago_users_user_user_permissions (id, user_id, permission_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_users_user_user_permissions_id_seq', 1, false);
...
COPY misago_users_usernamechange (id, changed_by_username, changed_on, new_username, old_username, changed_by_id, user_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('misago_users_usernamechange_id_seq', 1, false);
...
--
-- Name: gql_platform_author_pkey; Type: CONSTRAINT; Schema: public; Owner: mmuser
--

ALTER TABLE ONLY gql_platform_author
    ADD CONSTRAINT gql_platform_author_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY gql_platform_genre
    ADD CONSTRAINT gql_platform_genre_pkey PRIMARY KEY (id);


--
-- Name: gql_platform_mangaseries_pkey; Type: CONSTRAINT; Schema: public; Owner: mmuser
--

ALTER TABLE ONLY gql_platform_mangaseries
    ADD CONSTRAINT gql_platform_mangaseries_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY gql_platform_userstatus
...
ALTER TABLE ONLY misago_acl_role
...
ALTER TABLE ONLY misago_categories_category
...
ALTER TABLE ONLY misago_categories_categoryrole
...
ALTER TABLE ONLY misago_categories_rolecategoryacl
...
ALTER TABLE ONLY misago_conf_setting
...
ALTER TABLE ONLY misago_conf_settingsgroup
...
ALTER TABLE ONLY misago_core_cacheversion
...
ALTER TABLE ONLY misago_readtracker_postread
...
ALTER TABLE ONLY misago_threads_attachmenttype_limit_uploads_to
...
ALTER TABLE ONLY misago_threads_attachmenttype_limit_downloads_to
...
ALTER TABLE ONLY misago_threads_attachment
...
ALTER TABLE ONLY misago_threads_attachmenttype
...
ALTER TABLE ONLY misago_threads_poll
...
ALTER TABLE ONLY misago_threads_pollvote
...
ALTER TABLE ONLY misago_threads_post_mentions
...
ALTER TABLE ONLY misago_threads_post
...
ALTER TABLE ONLY misago_threads_postedit
...
ALTER TABLE ONLY misago_threads_postlike
...
ALTER TABLE ONLY misago_threads_subscription
...
ALTER TABLE ONLY misago_threads_thread
...
ALTER TABLE ONLY misago_threads_threadparticipant
...
ALTER TABLE ONLY misago_users_activityranking
...
ALTER TABLE ONLY misago_users_avatar
...
ALTER TABLE ONLY misago_users_avatargallery
...
ALTER TABLE ONLY misago_users_ban
...
ALTER TABLE ONLY misago_users_bancache
...
ALTER TABLE ONLY misago_users_online
...
ALTER TABLE ONLY misago_users_rank
...
ALTER TABLE ONLY misago_users_rank_roles
...
ALTER TABLE ONLY misago_users_user_blocks
...
ALTER TABLE ONLY misago_users_user
...
ALTER TABLE ONLY misago_users_user_follows
...
ALTER TABLE ONLY misago_users_user_groups
...
ALTER TABLE ONLY misago_users_user_roles
...
ALTER TABLE ONLY misago_users_user_user_permissions
...
ALTER TABLE ONLY misago_users_usernamechange
...
--
-- Name: gql_platform_mangaseries_author_id_3e5e4c56; Type: INDEX; Schema: public; Owner: mmuser
--

CREATE INDEX gql_platform_mangaseries_author_id_3e5e4c56 ON gql_platform_mangaseries USING btree (author_id);


--
-- Name: gql_platform_mangaseries_genre_id_e8276f50; Type: INDEX; Schema: public; Owner: mmuser
--

CREATE INDEX gql_platform_mangaseries_genre_id_e8276f50 ON gql_platform_mangaseries USING btree (genre_id);
...
CREATE INDEX gql_platform_userstatus_user_id_a33ca01c ON gql_platform_userstatus USING btree (user_id);
...
CREATE INDEX misago_categories_category_archive_pruned_in_id_e8c49844 ON misago_categories_category USING btree (archive_pruned_in_id);
...
CREATE INDEX misago_categories_category_last_poster_id_96db3f03 ON misago_categories_category USING btree (last_poster_id);
...
CREATE INDEX misago_categories_category_last_thread_id_44625647 ON misago_categories_category USING btree (last_thread_id);
...
CREATE INDEX misago_categories_category_level_59f71648 ON misago_categories_category USING btree (level);
...
CREATE INDEX misago_categories_category_lft_e86ba50d ON misago_categories_category USING btree (lft);
...
CREATE INDEX misago_categories_category_parent_id_1d85cfdc ON misago_categories_category USING btree (parent_id);
...
CREATE INDEX misago_categories_category_rght_53bdd53e ON misago_categories_category USING btree (rght);
...
CREATE INDEX misago_categories_category_tree_id_69f3b1ee ON misago_categories_category USING btree (tree_id);
...
CREATE INDEX misago_categories_rolecategoryacl_category_id_99c2a9bb ON misago_categories_rolecategoryacl USING btree (category_id);
...
CREATE INDEX misago_categories_rolecategoryacl_category_role_id_d3558bd9 ON misago_categories_rolecategoryacl USING btree (category_role_id);
...
CREATE INDEX misago_categories_rolecategoryacl_role_id_9e172a55 ON misago_categories_rolecategoryacl USING btree (role_id);
...
CREATE INDEX misago_conf_setting_group_id_5535b708 ON misago_conf_setting USING btree (group_id);
...
CREATE INDEX misago_conf_setting_order_47a1f455 ON misago_conf_setting USING btree ("order");
...
CREATE INDEX misago_conf_setting_setting_d5ff9d28_like ON misago_conf_setting USING btree (setting varchar_pattern_ops);
...
CREATE INDEX misago_conf_settingsgroup_key_94b95e3f_like ON misago_conf_settingsgroup USING btree (key varchar_pattern_ops);
...
CREATE INDEX misago_readtracker_postread_category_id_bb74f821 ON misago_readtracker_postread USING btree (category_id);
...
CREATE INDEX misago_readtracker_postread_post_id_2be75383 ON misago_readtracker_postread USING btree (post_id);
...
CREATE INDEX misago_readtracker_postread_thread_id_7121201f ON misago_readtracker_postread USING btree (thread_id);
...
CREATE INDEX misago_readtracker_postread_user_id_4a764d0f ON misago_readtracker_postread USING btree (user_id);
...
CREATE INDEX misago_thre_has_ope_479906_part ON misago_threads_post USING btree (has_open_reports) WHERE (has_open_reports = true);
...
CREATE INDEX misago_thre_has_rep_84acfa_part ON misago_threads_thread USING btree (has_reported_posts) WHERE (has_reported_posts = true);
...
CREATE INDEX misago_thre_has_una_b0dbf5_part ON misago_threads_thread USING btree (has_unapproved_posts) WHERE (has_unapproved_posts = true);
...
CREATE INDEX misago_thre_is_hidd_85db69_part ON misago_threads_post USING btree (is_hidden) WHERE (is_hidden = false);
...
CREATE INDEX misago_thre_is_hidd_d2b96c_part ON misago_threads_thread USING btree (is_hidden) WHERE (is_hidden = false);
...
CREATE INDEX misago_thre_search__b472a2_gin ON misago_threads_post USING gin (search_vector);
...
CREATE INDEX misago_thre_weight_955884_part ON misago_threads_thread USING btree (weight) WHERE (weight = 2);
...
CREATE INDEX misago_thre_weight_9e8f9c_part ON misago_threads_thread USING btree (weight) WHERE (weight = 1);
...
CREATE INDEX misago_thre_weight__4af9ee_part ON misago_threads_thread USING btree (weight) WHERE (weight < 2);
...
CREATE INDEX misago_thre_weight_c7ef29_part ON misago_threads_thread USING btree (weight) WHERE (weight = 0);
...
CREATE INDEX misago_threads_attachment_filename_4160d232 ON misago_threads_attachment USING btree (filename);
...
CREATE INDEX misago_threads_attachment_filename_4160d232_like ON misago_threads_attachment USING btree (filename varchar_pattern_ops);
...
CREATE INDEX misago_threads_attachment_filetype_id_d1e5d86e ON misago_threads_attachment USING btree (filetype_id);
...
CREATE INDEX misago_threads_attachment_post_id_68447b47 ON misago_threads_attachment USING btree (post_id);
...
CREATE INDEX misago_threads_attachment_size_b8dd6dfd ON misago_threads_attachment USING btree (size);
...
CREATE INDEX misago_threads_attachment_uploaded_on_08369cf7 ON misago_threads_attachment USING btree (uploaded_on);
...
CREATE INDEX misago_threads_attachment_uploader_id_9f21e391 ON misago_threads_attachment USING btree (uploader_id);
...
CREATE INDEX misago_threads_attachment_uploader_slug_383b098d ON misago_threads_attachment USING btree (uploader_slug);
...
CREATE INDEX misago_threads_attachment_uploader_slug_383b098d_like ON misago_threads_attachment USING btree (uploader_slug varchar_pattern_ops);
...
CREATE INDEX misago_threads_attachmentt_attachmenttype_id_6996d5c4 ON misago_threads_attachmenttype_limit_uploads_to USING btree (attachmenttype_id);
...
CREATE INDEX misago_threads_attachmentt_attachmenttype_id_7e25aa42 ON misago_threads_attachmenttype_limit_downloads_to USING btree (attachmenttype_id);
...
CREATE INDEX misago_threads_attachmentt_role_id_cc342315 ON misago_threads_attachmenttype_limit_downloads_to USING btree (role_id);
...
CREATE INDEX misago_threads_attachmenttype_limit_uploads_to_role_id_65cc8efd ON misago_threads_attachmenttype_limit_uploads_to USING btree (role_id);
...
CREATE INDEX misago_threads_poll_category_id_29fa5f5d ON misago_threads_poll USING btree (category_id);
...
CREATE INDEX misago_threads_poll_poster_id_49715f68 ON misago_threads_poll USING btree (poster_id);
...
CREATE INDEX misago_threads_pollvote_category_id_92abdceb ON misago_threads_pollvote USING btree (category_id);
...
CREATE INDEX misago_threads_pollvote_choice_hash_98c31747 ON misago_threads_pollvote USING btree (choice_hash);
...
CREATE INDEX misago_threads_pollvote_choice_hash_98c31747_like ON misago_threads_pollvote USING btree (choice_hash varchar_pattern_ops);
...
CREATE INDEX misago_threads_pollvote_poll_id_d3fbfddf ON misago_threads_pollvote USING btree (poll_id);
...
CREATE INDEX misago_threads_pollvote_poll_id_voter_name_0de4ca24_idx ON misago_threads_pollvote USING btree (poll_id, voter_name);
...
CREATE INDEX misago_threads_pollvote_thread_id_ef78c2ad ON misago_threads_pollvote USING btree (thread_id);
...
CREATE INDEX misago_threads_pollvote_voter_id_979ff29f ON misago_threads_pollvote USING btree (voter_id);
...
CREATE INDEX misago_threads_post_category_id_79f7f0ef ON misago_threads_post USING btree (category_id);
...
CREATE INDEX misago_threads_post_hidden_by_id_452f0812 ON misago_threads_post USING btree (hidden_by_id);
...
CREATE INDEX misago_threads_post_hidden_by_slug_df670716 ON misago_threads_post USING btree (hidden_by_slug);
...
CREATE INDEX misago_threads_post_hidden_by_slug_df670716_like ON misago_threads_post USING btree (hidden_by_slug varchar_pattern_ops);
...
CREATE INDEX misago_threads_post_is_event_ba70bc13 ON misago_threads_post USING btree (is_event);
...
CREATE INDEX misago_threads_post_is_event_is_hidden_c3871ba0_idx ON misago_threads_post USING btree (is_event, is_hidden);
...
CREATE INDEX misago_threads_post_is_unapproved_9240a4cc ON misago_threads_post USING btree (is_unapproved);
...
CREATE INDEX misago_threads_post_last_editor_id_56e47ea4 ON misago_threads_post USING btree (last_editor_id);
...
CREATE INDEX misago_threads_post_last_editor_slug_a28b663a ON misago_threads_post USING btree (last_editor_slug);
...
CREATE INDEX misago_threads_post_last_editor_slug_a28b663a_like ON misago_threads_post USING btree (last_editor_slug varchar_pattern_ops);
...
CREATE INDEX misago_threads_post_mentions_post_id_8d3c8c76 ON misago_threads_post_mentions USING btree (post_id);
...
CREATE INDEX misago_threads_post_mentions_user_id_515d18c5 ON misago_threads_post_mentions USING btree (user_id);
...
CREATE INDEX misago_threads_post_posted_on_00c20f4c ON misago_threads_post USING btree (posted_on);
...
CREATE INDEX misago_threads_post_poster_id_b3163b03 ON misago_threads_post USING btree (poster_id);
...
CREATE INDEX misago_threads_post_poster_id_posted_on_16636124_idx ON misago_threads_post USING btree (poster_id, posted_on);
...
CREATE INDEX misago_threads_post_thread_id_8083899e ON misago_threads_post USING btree (thread_id);
...
CREATE INDEX misago_threads_post_thread_id_id_b238a0d3_idx ON misago_threads_post USING btree (thread_id, id);
...
CREATE INDEX misago_threads_postedit_category_id_14762498 ON misago_threads_postedit USING btree (category_id);
...
CREATE INDEX misago_threads_postedit_editor_id_3c099285 ON misago_threads_postedit USING btree (editor_id);
...
CREATE INDEX misago_threads_postedit_post_id_831e29bb ON misago_threads_postedit USING btree (post_id);
...
CREATE INDEX misago_threads_postedit_thread_id_a71149fd ON misago_threads_postedit USING btree (thread_id);
...
CREATE INDEX misago_threads_postlike_category_id_21e0c8ce ON misago_threads_postlike USING btree (category_id);
...
CREATE INDEX misago_threads_postlike_liker_id_e9fbb1c9 ON misago_threads_postlike USING btree (liker_id);
...
CREATE INDEX misago_threads_postlike_liker_name_1ead3b48 ON misago_threads_postlike USING btree (liker_name);
...
CREATE INDEX misago_threads_postlike_liker_name_1ead3b48_like ON misago_threads_postlike USING btree (liker_name varchar_pattern_ops);
...
CREATE INDEX misago_threads_postlike_post_id_7ec34c1c ON misago_threads_postlike USING btree (post_id);
...
CREATE INDEX misago_threads_postlike_thread_id_38e33d41 ON misago_threads_postlike USING btree (thread_id);
...
CREATE INDEX misago_threads_subscript_send_email_last_read_on_d4a73c16_idx ON misago_threads_subscription USING btree (send_email, last_read_on);
...
CREATE INDEX misago_threads_subscription_category_id_f5854673 ON misago_threads_subscription USING btree (category_id);
...
CREATE INDEX misago_threads_subscription_thread_id_f97c9a3b ON misago_threads_subscription USING btree (thread_id);
...
CREATE INDEX misago_threads_subscription_user_id_daf28105 ON misago_threads_subscription USING btree (user_id);
...
CREATE INDEX misago_threads_thread_category_id_e3266490 ON misago_threads_thread USING btree (category_id);
...
CREATE INDEX misago_threads_thread_category_id_id_300d1b53_idx ON misago_threads_thread USING btree (category_id, id);
...
CREATE INDEX misago_threads_thread_category_id_last_post_on_d56dce6c_idx ON misago_threads_thread USING btree (category_id, last_post_on);
...
CREATE INDEX misago_threads_thread_category_id_replies_cde6b84a_idx ON misago_threads_thread USING btree (category_id, replies);
...
CREATE INDEX misago_threads_thread_first_post_id_b8139d81 ON misago_threads_thread USING btree (first_post_id);
...
CREATE INDEX misago_threads_thread_is_unapproved_a55fb408 ON misago_threads_thread USING btree (is_unapproved);
...
CREATE INDEX misago_threads_thread_last_post_id_c638dfb4 ON misago_threads_thread USING btree (last_post_id);
...
CREATE INDEX misago_threads_thread_last_post_on_10841b1c ON misago_threads_thread USING btree (last_post_on);
...
CREATE INDEX misago_threads_thread_last_poster_id_4fa32da6 ON misago_threads_thread USING btree (last_poster_id);
...
CREATE INDEX misago_threads_thread_replies_1617266c ON misago_threads_thread USING btree (replies);
...
CREATE INDEX misago_threads_thread_started_on_10445c64 ON misago_threads_thread USING btree (started_on);
...
CREATE INDEX misago_threads_thread_starter_id_7974db8c ON misago_threads_thread USING btree (starter_id);
...
CREATE INDEX misago_threads_threadparticipant_thread_id_d468a2cb ON misago_threads_threadparticipant USING btree (thread_id);
...
CREATE INDEX misago_threads_threadparticipant_user_id_efbeaf80 ON misago_threads_threadparticipant USING btree (user_id);
...
CREATE INDEX misago_user_is_staf_bf68aa_part ON misago_users_user USING btree (is_staff) WHERE (is_staff = true);
...
CREATE INDEX misago_user_require_05204a_part ON misago_users_user USING btree (requires_activation) WHERE (requires_activation > 0);
...
CREATE INDEX misago_users_activityranking_score_3e0a18df ON misago_users_activityranking USING btree (score);
...
CREATE INDEX misago_users_activityranking_user_id_a962add9 ON misago_users_activityranking USING btree (user_id);
...
CREATE INDEX misago_users_avatar_user_id_c3763aa1 ON misago_users_avatar USING btree (user_id);
...
CREATE INDEX misago_users_ban_banned_value_bd43b7e9 ON misago_users_ban USING btree (banned_value);
...
CREATE INDEX misago_users_ban_banned_value_bd43b7e9_like ON misago_users_ban USING btree (banned_value varchar_pattern_ops);
...
CREATE INDEX misago_users_ban_check_type_06e115d1 ON misago_users_ban USING btree (check_type);
...
CREATE INDEX misago_users_ban_expires_on_62433cd5 ON misago_users_ban USING btree (expires_on);
...
CREATE INDEX misago_users_ban_is_checked_e23bc0a6 ON misago_users_ban USING btree (is_checked);
...
CREATE INDEX misago_users_ban_registration_only_867b54d4 ON misago_users_ban USING btree (registration_only);
...
CREATE INDEX misago_users_bancache_ban_id_2766ed56 ON misago_users_bancache USING btree (ban_id);
...
CREATE INDEX misago_users_rank_roles_rank_id_662c3ee7 ON misago_users_rank_roles USING btree (rank_id);
...
CREATE INDEX misago_users_rank_roles_role_id_e0236d53 ON misago_users_rank_roles USING btree (role_id);
...
CREATE INDEX misago_users_rank_slug_80e8f022_like ON misago_users_rank USING btree (slug varchar_pattern_ops);
...
CREATE INDEX misago_users_user_blocks_from_user_id_a1352891 ON misago_users_user_blocks USING btree (from_user_id);
...
CREATE INDEX misago_users_user_blocks_to_user_id_b919ce82 ON misago_users_user_blocks USING btree (to_user_id);
...
CREATE INDEX misago_users_user_email_1cdb37a6 ON misago_users_user USING btree (email);
...
CREATE INDEX misago_users_user_email_1cdb37a6_like ON misago_users_user USING btree (email varchar_pattern_ops);
...
CREATE INDEX misago_users_user_email_hash_55ddd5b1_like ON misago_users_user USING btree (email_hash varchar_pattern_ops);
...
CREATE INDEX misago_users_user_follows_from_user_id_9575602d ON misago_users_user_follows USING btree (from_user_id);
...
CREATE INDEX misago_users_user_follows_to_user_id_8cc8eb10 ON misago_users_user_follows USING btree (to_user_id);
...
CREATE INDEX misago_users_user_groups_group_id_0b7c0680 ON misago_users_user_groups USING btree (group_id);
...
CREATE INDEX misago_users_user_groups_user_id_ddeac4e6 ON misago_users_user_groups USING btree (user_id);
...
CREATE INDEX misago_users_user_is_active_fc628eb4 ON misago_users_user USING btree (is_active);
...
CREATE INDEX misago_users_user_posts_79cba5f0 ON misago_users_user USING btree (posts);
...
CREATE INDEX misago_users_user_rank_id_25883ca9 ON misago_users_user USING btree (rank_id);
...
CREATE INDEX misago_users_user_roles_role_id_58d36725 ON misago_users_user_roles USING btree (role_id);
...
CREATE INDEX misago_users_user_roles_user_id_af2be819 ON misago_users_user_roles USING btree (user_id);
...
CREATE INDEX misago_users_user_slug_87d70f62_like ON misago_users_user USING btree (slug varchar_pattern_ops);
...
CREATE INDEX misago_users_user_user_permissions_permission_id_bd44102a ON misago_users_user_user_permissions USING btree (permission_id);
...
CREATE INDEX misago_users_user_user_permissions_user_id_264f5b9d ON misago_users_user_user_permissions USING btree (user_id);
...
CREATE INDEX misago_users_usernamechange_changed_by_id_bd7f6309 ON misago_users_usernamechange USING btree (changed_by_id);
...
CREATE INDEX misago_users_usernamechange_user_id_ef2d9164 ON misago_users_usernamechange USING btree (user_id);
...
ALTER TABLE ONLY django_admin_log
    ADD CONSTRAINT django_admin_log_user_id_c564eba6_fk_misago_users_user_id FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: gql_platform_mangase_author_id_3e5e4c56_fk_gql_platf; Type: FK CONSTRAINT; Schema: public; Owner: mmuser
--

ALTER TABLE ONLY gql_platform_mangaseries
    ADD CONSTRAINT gql_platform_mangase_author_id_3e5e4c56_fk_gql_platf FOREIGN KEY (author_id) REFERENCES gql_platform_author(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: gql_platform_mangase_genre_id_e8276f50_fk_gql_platf; Type: FK CONSTRAINT; Schema: public; Owner: mmuser
--

ALTER TABLE ONLY gql_platform_mangaseries
    ADD CONSTRAINT gql_platform_mangase_genre_id_e8276f50_fk_gql_platf FOREIGN KEY (genre_id) REFERENCES gql_platform_genre(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY gql_platform_userstatus
    ADD CONSTRAINT gql_platform_usersta_user_id_a33ca01c_fk_misago_us FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_categories_category
    ADD CONSTRAINT misago_categories_ca_archive_pruned_in_id_e8c49844_fk_misago_ca FOREIGN KEY (archive_pruned_in_id) REFERENCES misago_categories_category(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_categories_category
    ADD CONSTRAINT misago_categories_ca_last_poster_id_96db3f03_fk_misago_us FOREIGN KEY (last_poster_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_categories_category
    ADD CONSTRAINT misago_categories_ca_last_thread_id_44625647_fk_misago_th FOREIGN KEY (last_thread_id) REFERENCES misago_threads_thread(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_categories_category
    ADD CONSTRAINT misago_categories_ca_parent_id_1d85cfdc_fk_misago_ca FOREIGN KEY (parent_id) REFERENCES misago_categories_category(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_categories_rolecategoryacl
    ADD CONSTRAINT misago_categories_ro_category_id_99c2a9bb_fk_misago_ca FOREIGN KEY (category_id) REFERENCES misago_categories_category(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_categories_rolecategoryacl
    ADD CONSTRAINT misago_categories_ro_category_role_id_d3558bd9_fk_misago_ca FOREIGN KEY (category_role_id) REFERENCES misago_categories_categoryrole(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_categories_rolecategoryacl
    ADD CONSTRAINT misago_categories_ro_role_id_9e172a55_fk_misago_ac FOREIGN KEY (role_id) REFERENCES misago_acl_role(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_conf_setting
    ADD CONSTRAINT misago_conf_setting_group_id_5535b708_fk_misago_co FOREIGN KEY (group_id) REFERENCES misago_conf_settingsgroup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_readtracker_postread
    ADD CONSTRAINT misago_readtracker_p_category_id_bb74f821_fk_misago_ca FOREIGN KEY (category_id) REFERENCES misago_categories_category(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_readtracker_postread
    ADD CONSTRAINT misago_readtracker_p_post_id_2be75383_fk_misago_th FOREIGN KEY (post_id) REFERENCES misago_threads_post(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_readtracker_postread
    ADD CONSTRAINT misago_readtracker_p_thread_id_7121201f_fk_misago_th FOREIGN KEY (thread_id) REFERENCES misago_threads_thread(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_readtracker_postread
    ADD CONSTRAINT misago_readtracker_p_user_id_4a764d0f_fk_misago_us FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_attachmenttype_limit_uploads_to
    ADD CONSTRAINT misago_threads_attac_attachmenttype_id_6996d5c4_fk_misago_th FOREIGN KEY (attachmenttype_id) REFERENCES misago_threads_attachmenttype(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_attachmenttype_limit_downloads_to
    ADD CONSTRAINT misago_threads_attac_attachmenttype_id_7e25aa42_fk_misago_th FOREIGN KEY (attachmenttype_id) REFERENCES misago_threads_attachmenttype(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_attachment
    ADD CONSTRAINT misago_threads_attac_filetype_id_d1e5d86e_fk_misago_th FOREIGN KEY (filetype_id) REFERENCES misago_threads_attachmenttype(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_attachment
    ADD CONSTRAINT misago_threads_attac_post_id_68447b47_fk_misago_th FOREIGN KEY (post_id) REFERENCES misago_threads_post(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_attachmenttype_limit_uploads_to
    ADD CONSTRAINT misago_threads_attac_role_id_65cc8efd_fk_misago_ac FOREIGN KEY (role_id) REFERENCES misago_acl_role(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_attachmenttype_limit_downloads_to
    ADD CONSTRAINT misago_threads_attac_role_id_cc342315_fk_misago_ac FOREIGN KEY (role_id) REFERENCES misago_acl_role(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_attachment
    ADD CONSTRAINT misago_threads_attac_uploader_id_9f21e391_fk_misago_us FOREIGN KEY (uploader_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_poll
    ADD CONSTRAINT misago_threads_poll_category_id_29fa5f5d_fk_misago_ca FOREIGN KEY (category_id) REFERENCES misago_categories_category(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_poll
    ADD CONSTRAINT misago_threads_poll_poster_id_49715f68_fk_misago_users_user_id FOREIGN KEY (poster_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_poll
    ADD CONSTRAINT misago_threads_poll_thread_id_f200f01c_fk_misago_th FOREIGN KEY (thread_id) REFERENCES misago_threads_thread(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_pollvote
    ADD CONSTRAINT misago_threads_pollv_category_id_92abdceb_fk_misago_ca FOREIGN KEY (category_id) REFERENCES misago_categories_category(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_pollvote
    ADD CONSTRAINT misago_threads_pollv_poll_id_d3fbfddf_fk_misago_th FOREIGN KEY (poll_id) REFERENCES misago_threads_poll(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_pollvote
    ADD CONSTRAINT misago_threads_pollv_thread_id_ef78c2ad_fk_misago_th FOREIGN KEY (thread_id) REFERENCES misago_threads_thread(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_pollvote
    ADD CONSTRAINT misago_threads_pollv_voter_id_979ff29f_fk_misago_us FOREIGN KEY (voter_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_post_mentions
    ADD CONSTRAINT misago_threads_post__post_id_8d3c8c76_fk_misago_th FOREIGN KEY (post_id) REFERENCES misago_threads_post(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_post_mentions
    ADD CONSTRAINT misago_threads_post__user_id_515d18c5_fk_misago_us FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_post
    ADD CONSTRAINT misago_threads_post_category_id_79f7f0ef_fk_misago_ca FOREIGN KEY (category_id) REFERENCES misago_categories_category(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_post
    ADD CONSTRAINT misago_threads_post_hidden_by_id_452f0812_fk_misago_us FOREIGN KEY (hidden_by_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_post
    ADD CONSTRAINT misago_threads_post_last_editor_id_56e47ea4_fk_misago_us FOREIGN KEY (last_editor_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_post
    ADD CONSTRAINT misago_threads_post_poster_id_b3163b03_fk_misago_users_user_id FOREIGN KEY (poster_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_post
    ADD CONSTRAINT misago_threads_post_thread_id_8083899e_fk_misago_th FOREIGN KEY (thread_id) REFERENCES misago_threads_thread(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_postedit
    ADD CONSTRAINT misago_threads_poste_category_id_14762498_fk_misago_ca FOREIGN KEY (category_id) REFERENCES misago_categories_category(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_postedit
    ADD CONSTRAINT misago_threads_poste_editor_id_3c099285_fk_misago_us FOREIGN KEY (editor_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_postedit
    ADD CONSTRAINT misago_threads_poste_post_id_831e29bb_fk_misago_th FOREIGN KEY (post_id) REFERENCES misago_threads_post(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_postedit
    ADD CONSTRAINT misago_threads_poste_thread_id_a71149fd_fk_misago_th FOREIGN KEY (thread_id) REFERENCES misago_threads_thread(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_postlike
    ADD CONSTRAINT misago_threads_postl_category_id_21e0c8ce_fk_misago_ca FOREIGN KEY (category_id) REFERENCES misago_categories_category(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_postlike
    ADD CONSTRAINT misago_threads_postl_liker_id_e9fbb1c9_fk_misago_us FOREIGN KEY (liker_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_postlike
    ADD CONSTRAINT misago_threads_postl_post_id_7ec34c1c_fk_misago_th FOREIGN KEY (post_id) REFERENCES misago_threads_post(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_postlike
    ADD CONSTRAINT misago_threads_postl_thread_id_38e33d41_fk_misago_th FOREIGN KEY (thread_id) REFERENCES misago_threads_thread(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_subscription
    ADD CONSTRAINT misago_threads_subsc_category_id_f5854673_fk_misago_ca FOREIGN KEY (category_id) REFERENCES misago_categories_category(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_subscription
    ADD CONSTRAINT misago_threads_subsc_thread_id_f97c9a3b_fk_misago_th FOREIGN KEY (thread_id) REFERENCES misago_threads_thread(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_subscription
    ADD CONSTRAINT misago_threads_subsc_user_id_daf28105_fk_misago_us FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_thread
    ADD CONSTRAINT misago_threads_threa_category_id_e3266490_fk_misago_ca FOREIGN KEY (category_id) REFERENCES misago_categories_category(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_thread
    ADD CONSTRAINT misago_threads_threa_first_post_id_b8139d81_fk_misago_th FOREIGN KEY (first_post_id) REFERENCES misago_threads_post(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_thread
    ADD CONSTRAINT misago_threads_threa_last_post_id_c638dfb4_fk_misago_th FOREIGN KEY (last_post_id) REFERENCES misago_threads_post(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_thread
    ADD CONSTRAINT misago_threads_threa_last_poster_id_4fa32da6_fk_misago_us FOREIGN KEY (last_poster_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_thread
    ADD CONSTRAINT misago_threads_threa_starter_id_7974db8c_fk_misago_us FOREIGN KEY (starter_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_threadparticipant
    ADD CONSTRAINT misago_threads_threa_thread_id_d468a2cb_fk_misago_th FOREIGN KEY (thread_id) REFERENCES misago_threads_thread(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_threads_threadparticipant
    ADD CONSTRAINT misago_threads_threa_user_id_efbeaf80_fk_misago_us FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_activityranking
    ADD CONSTRAINT misago_users_activit_user_id_a962add9_fk_misago_us FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_avatar
    ADD CONSTRAINT misago_users_avatar_user_id_c3763aa1_fk_misago_users_user_id FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_bancache
    ADD CONSTRAINT misago_users_bancache_ban_id_2766ed56_fk_misago_users_ban_id FOREIGN KEY (ban_id) REFERENCES misago_users_ban(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_bancache
    ADD CONSTRAINT misago_users_bancache_user_id_8ce1ac71_fk_misago_users_user_id FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_online
    ADD CONSTRAINT misago_users_online_user_id_a38e83e3_fk_misago_users_user_id FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_rank_roles
    ADD CONSTRAINT misago_users_rank_ro_rank_id_662c3ee7_fk_misago_us FOREIGN KEY (rank_id) REFERENCES misago_users_rank(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_rank_roles
    ADD CONSTRAINT misago_users_rank_roles_role_id_e0236d53_fk_misago_acl_role_id FOREIGN KEY (role_id) REFERENCES misago_acl_role(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_user_blocks
    ADD CONSTRAINT misago_users_user_bl_from_user_id_a1352891_fk_misago_us FOREIGN KEY (from_user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_user_blocks
    ADD CONSTRAINT misago_users_user_bl_to_user_id_b919ce82_fk_misago_us FOREIGN KEY (to_user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_user_follows
    ADD CONSTRAINT misago_users_user_fo_from_user_id_9575602d_fk_misago_us FOREIGN KEY (from_user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_user_follows
    ADD CONSTRAINT misago_users_user_fo_to_user_id_8cc8eb10_fk_misago_us FOREIGN KEY (to_user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_user_groups
    ADD CONSTRAINT misago_users_user_gr_user_id_ddeac4e6_fk_misago_us FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_user_groups
    ADD CONSTRAINT misago_users_user_groups_group_id_0b7c0680_fk_auth_group_id FOREIGN KEY (group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_user
    ADD CONSTRAINT misago_users_user_rank_id_25883ca9_fk_misago_users_rank_id FOREIGN KEY (rank_id) REFERENCES misago_users_rank(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_user_roles
    ADD CONSTRAINT misago_users_user_ro_user_id_af2be819_fk_misago_us FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_user_roles
    ADD CONSTRAINT misago_users_user_roles_role_id_58d36725_fk_misago_acl_role_id FOREIGN KEY (role_id) REFERENCES misago_acl_role(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_user_user_permissions
    ADD CONSTRAINT misago_users_user_us_permission_id_bd44102a_fk_auth_perm FOREIGN KEY (permission_id) REFERENCES auth_permission(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_user_user_permissions
    ADD CONSTRAINT misago_users_user_us_user_id_264f5b9d_fk_misago_us FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_usernamechange
    ADD CONSTRAINT misago_users_usernam_changed_by_id_bd7f6309_fk_misago_us FOREIGN KEY (changed_by_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY misago_users_usernamechange
    ADD CONSTRAINT misago_users_usernam_user_id_ef2d9164_fk_misago_us FOREIGN KEY (user_id) REFERENCES misago_users_user(id) DEFERRABLE INITIALLY DEFERRED;
